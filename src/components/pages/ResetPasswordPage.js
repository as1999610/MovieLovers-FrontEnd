...
class ResetPasswordPage extends React.Component {
    ...
    componentDidMount() {
        this.props.confirmToken(this.props.match.params.token).then(() => this.setState({loading:false, success:true}))
    ...
    render() {
        ...
        return (
            <div>
                ...
                {!loading && success && <ResetPasswordForm aubmit={this.submit} token={token}/>}
